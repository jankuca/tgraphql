...
> {
  ...
  scalarParamField<K extends Extract<keyof Fields, string>, Params extends VariableFieldParams<Fields[K], {}>>(
    ...
    QueryFragments
  > {
    return new ObjectFragmentQueryType(this.resolverType, this.query.scalarParamField(key, paramInputs), this.name)
  }
  ...
  > {
    return new ObjectFragmentQueryType(
      this.resolverType,
      this.query.paramField(key, paramInputs, makeSubquery),
      this.name
    )
  }
  ...
  > {
    return new ObjectFragmentQueryType(
      this.resolverType,
      this.query.listParamField(key, paramInputs, makeSubquery),
      this.name
    )
  }
}
